...
const Testimonials = ({ content }: TestimonialsProps = {}) => {
  ...
  const data = content || t.testimonials;

  const testimonials = [
    {
      quote: data.reviews[1].quote,
      author: data.reviews[1].author,
    },
    {
      quote: data.reviews[2].quote,
      author: data.reviews[2].author,
    },
    {
      quote: data.reviews[3].quote,
      author: data.reviews[3].author,
    },
  ];
